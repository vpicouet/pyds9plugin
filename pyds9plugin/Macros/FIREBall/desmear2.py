...
for j in tqdm(range(0,mask_data_ind.shape[1])):
       ...
       while mask_data[yind,xval] == 1:#  bug only with mad! and new_img_data[yind,(xval+1)] < bias - (5*sigma):
           xval = xval + 1
           counter = counter + 1
           if xval == mask_data.shape[1]-1:
               break
